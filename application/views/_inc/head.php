			...
			<nav class="main_nav_container">
				<div class="main_nav">
					<ul class="main_nav_list">
						...
						<li class="main_nav_item"><a href="#">SOBRE N&Oacute;S</a></li>
						...
						<li class="main_nav_item"><a href="<?php echo base_url()?>IndexCont/login">IPP VITRINE</a></li>
					</ul>
				</div>
			</nav>
		</div>
        ...
        <div class="menu_inner menu_mm">
            <div class="menu menu_mm">
                <ul class="menu_list menu_mm">
                    ...
                    <li class="menu_item menu_mm"><a href="#">SOBRE N&Oacute;S</a></li>
					...
					<li class="menu_item menu_mm"><a href="<?= site_url('index/login')?>">IPP VITRINE</a></li>
                </ul>
