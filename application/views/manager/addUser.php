                            ...
                            <form id="formAlun" action="<?=base_url()?>Forms/addUser" method="post" class="form user mt-5">
                                ...
                                <div class="row mt-5 form-group">
                                    <div class="form-field col-sm-6 mb-sm-0 mb-4">
                                        <select name="name" id="disponibilidade" class="form-control form-control-user selectpicker" data-width="100%" title='***SELECIONE O NOME DO USER***' data-live-search="true">
