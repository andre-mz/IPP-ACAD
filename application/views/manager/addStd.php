<?php $this->load->view('_inc/dashHead')?>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 dataTable-top">
            <h6 class="m-0 font-weight-bold text-primary">ADICIONAR NOVO FORMANDO</h6>
        </div>
        <div class="card-body">
            <form id="formAluno" action="<?=site_url('Forms/add')?>" method="post" class="form user mt-5">
                ...
                <div class='form-field row mt-5 form-group'>
                    ...
                    <div class="form-field col-sm-4 mb-sm-0 mb-4">
                        <select name="curso" class="form-control form-control-user selectpicker" data-width="100%" title='***CURSO***' data-live-search="true">
